<template>
  <LayoutPage>
    <div class="flex-1 md:p-8 overflow-auto">
      ...
      <div class="mt-10 mb-15 text-center text-gray-800 dark:text-black text-lg">
        Mengelola keuangan bukan hanya tentang mencatat pemasukan dan pengeluaran, tapi
        tentang membangun kebiasaan yang membawa kita lebih dekat pada stabilitas dan
        impian finansial. Dengan langkah kecil yang konsisten, kamu sudah selangkah lebih
        maju menuju masa depan yang lebih aman dan terencana. Terus lanjutkan, karena
        setiap rupiah yang kamu kelola hari ini akan menentukan kenyamanan hidupmu esok
        hari. 💰📈
      </div>
      ...
      <section class="bg-blue-200 rounded-lg py-16 px-4">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <!-- Card 1 -->
          <div class="bg-blue-700 text-white p-6 rounded-2xl shadow-md relative">
            ...
            <div class="pt-12">
              <h3 class="text-xl font-bold text-green-400 mb-2">Tujuan Keuangan</h3>
              <p class="text-sm">
          ...
          <div class="bg-blue-700 text-white p-6 rounded-2xl shadow-md relative">
            ...
            <div class="pt-12">
              <h3 class="text-xl font-bold text-green-400 mb-2">Catat Transaksi</h3>
              <p class="text-sm">
                Otomatis atau manual, catat tiap pengeluaran untuk hari-hari anti boncos
                mendatang.
              </p>
            </div>
          </div>
          ...
          <div class="bg-blue-700 text-white p-6 rounded-2xl shadow-md relative">
            ...
            <div class="pt-12">
              ...
              <p class="text-sm">
                ...
                Atur anggaran keuangan kamu untuk segala kebutuhan bareng Sribuu.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div class="w-full md:w-1/2 flex flex-col items-start text-left gap-4">
          ...
          <p class="text-gray-500 text-lg">
            Dapatkan insight dan rekomendasi bulanan yang bisa ngasih kamu arahan biar
            lebih bijak dalam ngatur uang.
          </p>
        </div>
      </div>
      ...
      <div class="md:justify-center mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div class="flex flex-col items-center text-center">
            ...
            />
            <h2 class="text-xl md:text-2xl font-bold text-gray-700">Siap Pakai</h2>
            <p class="text-base md:text-lg text-gray-700">
              Tanpa perlu buat program dari awal, tinggal daftar dan langsung gunakan
            </p>
          </div>
          ...
          <div class="flex flex-col items-center text-center">
            ...
            <p class="text-base md:text-lg text-gray-700">
              Bebas biaya, pencatatan otomatis terintegrasi dengan setiap invoice
              pembelian dan penjualan di Website MAYTRA Finance
            </p>
          </div>
          ...
          <div class="flex flex-col items-center text-center">
            ...
            <p class="text-base md:text-lg text-gray-700">
              Website yang simple, tapi sangat bermanfaat dan mudah digunakan untuk pemula
            </p>
          </div>
...
onMounted(() => {
  ...
  dataPieChartPengeluaran.value.data.labels = Object.keys(kategoriPengeluaranMap);
